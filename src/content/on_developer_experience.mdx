...
description: "What makes a great Developer Experience (DX)?"
isPublished: true
publishDate: "2021-09-12"
slug: "on_developer_experience"
---
...
```js {4} showLineNumbers title="Example of using floating UI" file="src/components/MyComponent.tsx"
...
function MyComponent() {
  ...
  return (
    <div ref={refs.container} style={floatingStyles.container}>
      <button ref={refs.button} style={floatingStyles.button}>
        Click me!
      </button>
    </div>
  );
